namespace Homies.Common
{
    public static class ApplicationConstants
    {
        ...
        public const string DateTimeGeneralFormat = "yyyy-MM-dd H:mm";
        public const string DetailsDateFormat = "dd-MM-yyyy H:mm";
        public const string JoinedEventsDateFormat = "dd-MM-yyyy H:mm";
